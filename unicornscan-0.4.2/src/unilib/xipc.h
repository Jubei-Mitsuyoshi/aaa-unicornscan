...
int ipc_init(void);
int create_server_socket(const struct sockaddr_in * /* listen info */);
int create_client_socket(drone_t * /* connection info */, struct sockaddr_in * /* localbind info */);
int wait_for_client(int /* socket to wait on */);

int send_message(int /* socket */, int /* type */, int /* status */, uint8_t * /* data */, uint32_t /* datalen */);
